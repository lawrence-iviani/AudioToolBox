function varargout = GUI_DUALCHANNELFFT_FFTGeneratorParams(varargin)
% GUI_DUALCHANNELFFT_FFTGeneratorParams M-file for GUI_DUALCHANNELFFT_FFTGeneratorParams.fig
%      GUI_DUALCHANNELFFT_FFTGeneratorParams, by itself, creates a new GUI_DUALCHANNELFFT_FFTGeneratorParams or raises the existing
%      singleton*.
%
%      H = GUI_DUALCHANNELFFT_FFTGeneratorParams returns the handle to a new GUI_DUALCHANNELFFT_FFTGeneratorParams or the handle to
%      the existing singleton*.
%
%      GUI_DUALCHANNELFFT_FFTGeneratorParams('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_DUALCHANNELFFT_FFTGeneratorParams.M with the given input arguments.
%
%      GUI_DUALCHANNELFFT_FFTGeneratorParams('Property','Value',...) creates a new GUI_DUALCHANNELFFT_FFTGeneratorParams or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_DUALCHANNELFFT_FFTGeneratorParams_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_DUALCHANNELFFT_FFTGeneratorParams_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_DUALCHANNELFFT_FFTGeneratorParams

% Last Modified by GUIDE v2.5 15-Jan-2011 21:45:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_DUALCHANNELFFT_FFTGeneratorParams_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_DUALCHANNELFFT_FFTGeneratorParams_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_DUALCHANNELFFT_FFTGeneratorParams is made visible.
function GUI_DUALCHANNELFFT_FFTGeneratorParams_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_DUALCHANNELFFT_FFTGeneratorParams (see VARARGIN)

% Choose default command line output for GUI_DUALCHANNELFFT_FFTGeneratorParams
...
% UIWAIT makes GUI_DUALCHANNELFFT_FFTGeneratorParams wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_DUALCHANNELFFT_FFTGeneratorParams_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
GUI_DUALCHANNELFFT_FFTGeneratorParams_OutputFcn(handles, eventdata, handles); 
