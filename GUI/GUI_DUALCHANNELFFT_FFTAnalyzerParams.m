function varargout = GUI_DUALCHANNELFFT_FFTAnalyzerParams(varargin)
% GUI_DUALCHANNELFFT_FFTAnalyzerParams M-file for GUI_DUALCHANNELFFT_FFTAnalyzerParams.fig
%      GUI_DUALCHANNELFFT_FFTAnalyzerParams, by itself, creates a new GUI_DUALCHANNELFFT_FFTAnalyzerParams or raises the existing
%      singleton*.
%
%      H = GUI_DUALCHANNELFFT_FFTAnalyzerParams returns the handle to a new GUI_DUALCHANNELFFT_FFTAnalyzerParams or the handle to
%      the existing singleton*.
%
%      GUI_DUALCHANNELFFT_FFTAnalyzerParams('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_DUALCHANNELFFT_FFTAnalyzerParams.M with the given input arguments.
%
%      GUI_DUALCHANNELFFT_FFTAnalyzerParams('Property','Value',...) creates a new GUI_DUALCHANNELFFT_FFTAnalyzerParams or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_DUALCHANNELFFT_FFTAnalyzerParams_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_DUALCHANNELFFT_FFTAnalyzerParams_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_DUALCHANNELFFT_FFTAnalyzerParams

% Last Modified by GUIDE v2.5 16-Jan-2011 22:06:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_DUALCHANNELFFT_FFTAnalyzerParams_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_DUALCHANNELFFT_FFTAnalyzerParams_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_DUALCHANNELFFT_FFTAnalyzerParams is made visible.
function GUI_DUALCHANNELFFT_FFTAnalyzerParams_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_DUALCHANNELFFT_FFTAnalyzerParams (see VARARGIN)

% Choose default command line output for GUI_DUALCHANNELFFT_FFTAnalyzerParams
handles.output = hObject;
handles.changed=false;
if nargin == 4 && ~isempty(varargin{1})
    handles.params = varargin{1};
else 
    warning('GUI_DUALCHANNELFFT_FFTAnalyzerParams: arbitrary default params. Selecting fs=44100');
...
% UIWAIT makes GUI_DUALCHANNELFFT_FFTAnalyzerParams wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_DUALCHANNELFFT_FFTAnalyzerParams_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
GUI_DUALCHANNELFFT_FFTAnalyzerParams_OutputFcn(handles, eventdata, handles); 
