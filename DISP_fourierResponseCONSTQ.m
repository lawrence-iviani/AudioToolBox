function fig=DISP_fourierResponseCONSTQ(f ,H , grpDly, varargin)
% Display the fourier response with Constant Q of H,
% freq: the frequency axes
% grpDly: the group delay of the transformation
% TODO: insert the possibilities of render the coherence
...
set(fig,'Name' ,[ titleString ':  const Q=' num2str(bpo)  ' Smooth=' num2str(SMOOTH) ]);
top=0.03;
bottom=0.07;
left=0.05;
width=1-2*left;
