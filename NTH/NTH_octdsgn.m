...
% % Acknowledgement
% % 
% % This program is a recreation of oct3dsgn by Christophe Couvreur.  
...
% % Output Variables
% % 
% % B is an array of filter coefficients.
% % 
% % A is an array of filter coefficients.
% %
% % **********************************************************************
%  
% 
...
% % **********************************************************************
% % 
% % Program was recreated by Edward L. Zechmann from Christophe Couvreur. 
% %
...
if (Fc > 0.88*(Fs/2))
  error('NTH_octdsgn: Design not possible. Check frequencies.');
end
  
% Design Butterworth 2nth-order one-Nth-octave filter 
